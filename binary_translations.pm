...
sub data {
    return (
        ...
        "※艦娘保有数が上限に近いため、新しい艦娘と邂逅できない可能性があります。" =>
          { tr => "※If you have too many Ship Girls, there is a chance of not getting a Ship Girl reward.", desc => 'Edited for consistency.', ok => "a-csharp 4567477" },
        ...
        "艦隊選択"               => { tr => "Fleet Selection",      desc => 'Selection|map screen left right d-pad', ok => 'level19/level19_00052.-4 196' },
        ...
        "設定"                                      => { tr => "Task Confirmation",      desc => 'Task Content Confirmation | settings', ok => 'a-csharp 4851256' },
        ...
        "ロック"                                   => { tr => "Lock",      desc => 'ship list', ok => 'a-csharp 4532088' },
        "ソート"                                   => { tr => "Sort",      desc => 'ship list', ok => 'a-csharp 4519060' },
        ...
        "「旗艦提督室への移動」 達成" => { tr => "Go to the Flagship Office Get!",      desc => '', ok => 'a-csharp 4533878' },
        "「作戦海域への出撃！」 達成" => { tr => "Region Sortie Get!",      desc => '', ok => 'a-csharp 4573639' },
        "「ターン終了」 達成"             => { tr => "Turn End Get!",      desc => 'End of Turn', ok => 'a-csharp 4573255' },
        ...
        "被弾回避率補正" => { tr => "Evade Correction",     desc => '',   ok => 'a-csharp 4556831' },
        "攻撃命中率補正" => { tr => "Air Correction",     desc => '',  ok => 'a-csharp 4556815'},
        "雷撃命中率補正" => { tr => "Torpedo Correction",      desc => '',  ok => 'a-csharp 4556847' },
        "海上護衛艦隊の対潜/対空能力:{0}" => { tr => "Anti-Sub/Anti-Air Escort Fleet Capacity",      desc => "not in the source code?", ok => 'a-csharp 4604319' },
        "海上護衛艦隊(MemId:{0})は{1}のダメージ({2})" => { tr => "Escort Fleet Damage",      desc => 'I think', ok => 'a-csharp 4604361' },
        ...
        "廃棄は □ボタンで行います" => { tr => "Press □ for Disposal",      ok => 'a-csharp 4517038', desc => "Arsenal.TaskArsenalListManager"},
        "解体は □ボタンで行います" => { tr => "Press □ to Dismantle",      ok => 'a-csharp 4517066', desc => "Arsenal.TaskArsenalListManager"},
        ...
        "[000000]作戦海域への出撃時に、マップ上で [006400]Lボタン[-]\n切り替え\rによって、戦闘演出をカットして\n戦闘時間を短縮する\r[0055aa]戦闘ショートカット[-]が\n可能です。\n\n出撃&戦闘\rに慣れてきたら、ご活用ください。\nただし、未攻略海域の最深部、敵主力艦隊\nとの交戦は、戦闘ショートカットできません。[-]" =>{ tr => "When you are used to how a map works, you may use Battle Shortcut. By pressing the L-Shoulder button during the Sortie Map, you can shorten battle times. However, in fleet battles with new areas, Battle Shortcut may not be used.",      desc => '', ok=>'resources/resources_01570.-10 196'},
        ...
        "未配備の輸送船数:{0}(この海域への移動中:{1}) - 総数:{2}" => { tr => "Undeployed Vessels:{0}(Moving to this Region:{1}) - Total",      desc => 'Number of Undeployed Vessels:{0}(Moving to this Region:{1}) - Total', ok => 'a-csharp 4595279' },
        "輸送船 x {0}" => { tr => "Transport Ships x {0}",      desc => '', ok => 'a-csharp 4489180'},
        ...
        "Inspectorで設定して使用します。"                                                                                  => { tr => "",      desc => "not used in game, silences the scanner", ok => 'a-csharp 4847047' },
        "Inspector上でイベントを設定する為に使用するのでスクリプトないでは使用しないでください" => { tr => "",       desc => "not used in game, silences the scanner", ok => 'a-csharp 4847289' },
        "Inspector上でボタンに設定する為に使用します"                                                                => { tr => "",       desc => "not used in game, silences the scanner", ok => 'a-csharp 4846701' },
        "Inspector上で使用します。"                                                                                           => { tr => "",       desc => "not used in game, silences the scanner", ok => 'a-csharp 4847198' },
        "Inspector上で使用します"                                                                                              => { tr => "",       desc => "not used in game, silences the scanner", ok => 'a-csharp 4855717' },
        "Inspector上で使用するメソッドです"                                                                               => { tr => "",       desc => "not used in game, silences the scanner", ok => 'a-csharp 4847237' },
        "Inspector上で設定して使用したい...."                                                                              => { tr => "",       desc => "not used in game, silences the scanner", ok => 'a-csharp 4847146' },
        "Inspector上で設定して使用します。"                                                                               => { tr => "",       desc => "not used in game, silences the scanner", ok => 'a-csharp 4844461' },
        "Inspector上で設定して使用します"                                                                                  => { tr => "",       desc => "not used in game, silences the scanner", ok => 'a-csharp 4844533' },
        "Inspector上で選択して使用します."                                                                                 => { tr => "",       desc => "not used in game, silences the scanner", ok => 'a-csharp 4844581' },
        "Inspector上に設定して使用します"                                                                                  => { tr => "",       desc => "not used in game, silences the scanner", ok => 'a-csharp 4847418' },

        "艦隊は遠征中です"=>{ tr => "Fleet is on Expedition",       desc => "UIShortCutMenu", ok => 'a-csharp 4495756'},
        "艦隊を編成する必要があります"=>{ tr => "Organize a Fleet",      desc => "UIPortFrame, UIShortCutMenu", ok => 'a-csharp 4495810'},
        "撤退中の艦が含まれています"=>{ tr => "Withdrawing Ships Included",      desc => "UIShortCutMenu", ok => 'a-csharp 4495840'},
        "鎮守府海域でのみ選択可能です"=>{ tr => "Only selectable at Main Base",      desc => "UIShortCutMenu", ok => 'a-csharp 4495868'},
        "旗艦が工作艦である必要があります"=>{ tr => "Akashi must be your Flagship",      desc => "Your Flagship must be a Repair Ship | UIShortCutMenu", ok => 'a-csharp 4495898'},
        "決戦！ショートカット不可"=>{ tr => "Decisive Battle! Shortcut not available",      desc => "UIShortCutSwitch", ok => 'a-csharp 4496090'},
        "戦闘ショートカット"=>{ tr => "Battle Shortcut",      desc => "UIShortCutSwitch", ok => 'a-csharp 4496070'},
        "開発資材のインデックスが不正です"=>{ tr => "Invalid Development Material Index",      desc => "Arsenal.Arsenal_DevKit", ok => 'a-csharp 4610075' },
        "戦略ポイントのインデックスが不正です"=>{ tr => "Invalid Strategy Point Index",      desc => "Arsenal.Arsenal_SPoint", ok => 'a-csharp 4610109' },
        "輸送船を"=>{ tr => "Transport Ship",      desc => "を is not translated | Arsenal.ArsenalTankerDialog"                 },
        "隻入手しました"=>{ tr => "Ships Acquired",      desc => "隻 is a counter for ships. this could be very different, | Arsenal.ArsenalTankerDialog", ok => 'a-csharp 4516794'},
        "艦がロックされています"=>{ tr => "Ship is locked",      desc => "Arsenal.TaskArsenalListManager", ok => 'a-csharp 4517094'},
        "ロックされている装備があります"=>{ tr => "Equipment is locked",      desc => "Arsenal.TaskArsenalListManager", ok => 'a-csharp 4517118'},
        "建造"=>{ tr => "Construction",      desc => "Constructed? | .Arsenal.TaskConstructManager",},
        "大型建造"=>{ tr => "LSC\x{200B}",      desc => "Large Ship Construction | .Arsenal.TaskConstructManager", ok => 'a-csharp 4517764'},
        "開発"=>{ tr => "Development",      desc => ".Arsenal.TaskConstructManager",},
        "輸送船建造"=>{ tr => "Transport Construction",      desc => ".Arsenal.TaskConstructManager",},
        "戦略ポイントが不足しています"=>{ tr => "Not enough Strategy Points",      desc => ".Arsenal.TaskConstructManager", ok => 'a-csharp 4518318'},
        "解体  艦種  艦名　　　　　      Lv"=>{ tr => "Dismantle  Class  Name",      desc => "Arsenal.TaskMainArsenalManager", ok => 'a-csharp 4518706'},
        "廃棄      装備名　　　　　　　　　 レア"=>{ tr => "Disposal      Name　　　　　　　　　 Rarity",      desc => "Arsenal.TaskMainArsenalManager", ok => 'a-csharp 4518754'},
        ...
        "随伴艦の"=>{ tr => "Accompanying Ship",      desc => "の indicates a posessive | Battle.Production.ProdEscortShipEvacuation", ok => 'a-csharp 4557329'},
        "を護衛につけて戦場から退避させますか？"=>{ tr => "Escape from battle with Escorts?",      desc => "rough | Battle.Production.ProdEscortShipEvacuation", ok => 'a-csharp 4557339'},
        "『{0}』艦隊<br>旗艦「{1}」が<br>大破しました。"=>{ tr => qq[The Fleet Flagship "{1}" is wrecked.],      desc => "Battle.Production.ProdFlagshipWreck", ok => ['a-csharp 4557605', 'a-csharp 4698449']},
        "進撃は困難です……帰投します。"=>{ tr => "Advance is impossible……returning to base.",      desc => "Battle.Production.ProdFlagshipWreck", ok => ['a-csharp 4557685', 'a-csharp 4698510']},
        "敵反攻作戦 迎撃成功!!"=>{ tr => "Enemy counterattack interception successful!!",      desc => "Battle.Production.ProdThalassocracy", ok => 'a-csharp 4558267'},
        "「{0}」リクエスト中♪"=>{ tr => qq["{0}" requested♪],      desc => "Furniture.JukeBox.UIJukeBoxMusicPlayingDialog", ok => 'a-csharp 4532096'},
        "家具コインが不足しています"=>{ tr => "Not enough furniture coins",      desc => "Furniture.JukeBox.UserInterfaceJukeBoxManager", ok => 'a-csharp 4532184'},
        "購入 - {0} - "=>{ tr => "Purchase - {0} - ",      desc => "InteriorStore.UIFurniturePurchaseDialog", ok => 'a-csharp 4525706'},
        "不要"=>{ tr => "Do not",      desc => "InteriorStore.UIFurniturePurchaseDialog", ok => 'a-csharp 4525736'},
        "必要"=>{ tr => "Need",      desc => "Required | InteriorStore.UIFurniturePurchaseDialog",},
        "給糧艦「間宮」を使用しますか？"=>{ tr => qq[Use "Mamiya"?"\x{200B}\x{200B}\x{200B}\x{200B}],      desc => qq[Do you wish to use "Mamiya"? | Organize.OrganizeTender], ok => 'a-csharp 4529162'},
        "給糧艦「伊良湖」を使用しますか？"=>{ tr => qq[Use "Irako"?"\x{200B}\x{200B}\x{200B}\x{200B}\x{200B}],      desc => qq[Do you wish to use "Irako"? | Organize.OrganizeTender], ok => 'a-csharp 4529302'},
        "艦隊名を入力してください。（12文字まで）"=>{ tr => "Please enter fleet name. (Up to 12 characters)",      desc => "Organize.TaskOrganizeTop", ok => 'a-csharp 4532034'},
        "「"=>{ tr => qq["],      desc => "Production.ProdBattleRewardItem",},
        "」を" =>{ tr => qq["\x{200B}],      desc => "Production.ProdBattleRewardItem",},
        "入手しました。"=>{ tr => "Acquired",      desc => "Production.ProdBattleRewardItem", ok => 'a-csharp 4492312'},
        "」を入手しました。" =>{ tr => qq[" acquired. ],      desc => "Production.ProdBattleRewardItem", ok => 'a-csharp 4492328'},
        " 装備の開発に失敗しました。\n\n『開発資材』は消費しませんでした。" =>{ tr => "Equipment Development failed. \n\nNo development materials consumed.",      desc => "Production.ProdReceiveSlotItem", ok => 'a-csharp 4492850'},
        "部隊再編中…"=>{ tr => "Force edit repeated…",      desc => "??? | Production.ProdRevampReceiveItem", ok => 'a-csharp 4493086'},
        "装備改修中…"=>{ tr => "Equipment renovation…",      desc => "??? | Production.ProdRevampReceiveItem", ok => 'a-csharp 4493100'},
        "{0}に装備が改修更新されました！"=>{ tr => "{0} was updated!\x{200B}\x{200B}",      desc => "Production.ProdRevampReceiveItem", ok => 'a-csharp 4493138'},
        "{0}に部隊再編完了！"=>{ tr => "{0} task completed!",      desc => "Production.ProdRevampReceiveItem", ok => 'a-csharp 4493114'},
        "艦が保有上限に達しています" =>{ tr => "Maximum Ship Girl Limit Reached",      desc => "Scene.Duty.UserInterfaceDutyManager", ok => 'a-csharp 4524382'},
        "装備が保有上限に達しています"=>{ tr => "Maximum Equipment Limit Reached",      desc => "Scene.Duty.UserInterfaceDutyManager", ok => 'a-csharp 4524410'},
        "該当装備がロックされています" =>{ tr => "Relevant Equipment Locked",      desc => "Scene.Duty.UserInterfaceDutyManager", ok => 'a-csharp 4524352'},
        "撤退中の艦を含んでいます"=>{ tr => "Contains Withdrawing Ships",      desc => "Strategy.DeckStateViews", ok => 'a-csharp 4567087'},
        "補給対象の艦が居ません" =>{ tr => "No Ship To Supply",      desc => "Strategy.DeckStateViews", ok => 'a-csharp 4567113'},
        "資源が不足しています"  =>{ tr => "Resources Are Low",      desc => "Strategy.DeckStateViews", ok => 'a-csharp 4567137'},
        "撤退中の艦は入渠出来ません"=>{ tr => "A withdrawing ship can not dock",      desc => "Strategy.DeckStateViews", ok => 'a-csharp 4567159'},
        "高速修復材を持っていません" =>{ tr => "No Instant Repair Materials Available",      desc => "Strategy.DeckStateViews", ok => 'a-csharp 4567187'},
        "この海域には入渠ドックがありません"=>{ tr => "There is no dock in this region",      desc => "UIShortCutMenu, Strategy.DeckStateViews", ok => 'a-csharp 4495932'},
        "入渠ドックに空きがありません"  =>{ tr => "No Space In Docks",      desc => "Strategy.DeckStateViews", ok => 'a-csharp 4567215'},
        "艦隊の前方にうずしおが発生しました！"=>{ tr => "A maelstrom has appeared in front of the fleet!",      desc => "SortieMap.Defines", ok => ['a-csharp 4563245', 'a-csharp 4698597']},
        "{0}x{1}\nを入手しました！"=>{ tr => "{0}x{1}\nGained!\x{200B}",      desc => "SortieMap.Defines", ok => [ 'a-csharp 4563211', 'a-csharp 4698634']},
        "{0}x{1}を\n落としてしまいました…。"=>{ tr => "{0}x{1}\nHas been lost….",      desc => "SortieMap.Defines", ok => ['a-csharp 4563367','a-csharp 4698667']},
        "{0}x{1}を\n落としてしまいました…。\n(電探が役立って、被害を抑えられた！)"=>{ tr => "{0}x{1}\nHas been lost…. \n(Radar used, damage mitigated!)",      desc => "SortieMap.Defines", ok => ['a-csharp 4563283','a-csharp 4698710',]},
        "気のせいだった。"=>{ tr => "Nothing happened.",      desc => "SortieMap.Defines",ok=>['a-csharp 4565013','a-csharp 4698818']},
        ...
        "水上偵察機による\n航空偵察を実施します。"=>{ tr => "Conducting reconnaissance with Scout Aircraft.",      desc => "SortieMap.Defines", ok => ['a-csharp 4565165', 'a-csharp 4698911']},
        "大型飛行艇による\n航空偵察を実施します。"=>{ tr => "Conducting reconnaissance with Flying Boat.",      desc => "Large Sized Aircraft | SortieMap.Defines", ok => ['a-csharp 4565123', 'a-csharp 4698952']},
        "航空偵察予定地点に到着しましたが、\n稼働偵察機がないため、偵察を中止します。"=>{ tr => "Arrived at scheduled Aerial Recon Zone. No active aircraft available. Cancelling reconnaissance.",      desc => "SortieMap.Defines", ok => ['a-csharp 4565045', 'a-csharp 4698993']},
        "艦隊に洋上補給を行います。"=>{ tr => "Carrying out deployed fleet supply.",      desc => "SortieMap.Defines", ok => ['a-csharp 4563903', 'a-csharp 4699070']},
        "艦隊針路\n選択可能!"=>{ tr => "Fleet Course Selection Possible!",      desc => "SortieMap.Defines", ok => ['a-csharp 4563503', 'a-csharp 4699097']},
        ...
        "雷1" => {ok => 'resources/resources_00001.-5 1212', tr => "Ikazuchi1",      desc => 'destroyer' },
        "雷撃演習\nが開放されました！ " => { tr => "Torpedo Exercises now open!",      desc => '' },
        "雷改" => { tr => "Ikazuchi Kai",      desc => '' },
        "雷装" => { tr => "Torpedo",      desc => '' },
        "電1" => {ok => 'resources/resources_00001.-5 1248', tr => "Inazuma1",      desc => 'destroyer' },
